...
mod tests {
    ...
    fn test_call_muldiv_ceil() {
        ...
        let result = a.mul_div_ceil_naiv(b, c).unwrap();
    ...
    proptest! {
        ...
        fn test_check_mul_div_invariants(a: u8, b: u8, c in 1..u8::MAX) {
            ...
            let r_ceil = aa.mul_div_ceil_naiv(bb, denom);
            let r_floor = aa.mul_div_floor_naiv(bb, denom);
